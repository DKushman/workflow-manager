...
export default function WebDevWorkflow() {
  ...
  const loadData = async () => {
    try {
      const result = await window.storage.get('clients-data');
      if (result) {
  ...
  const saveData = async () => {
    if (clients.length > 0) {
      try {
        await window.storage.set('clients-data', JSON.stringify(clients));
      } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="max-w-7xl mx-auto px-12 py-8">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-3">
                <button
                  onClick={exportData}
                  className="px-5 py-3 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all flex items-center gap-2 text-sm"
                >
                  <Download size={16} />
                  Export
                </button>
                <label className="px-5 py-3 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all flex items-center gap-2 text-sm cursor-pointer">
                  <Upload size={16} />
                  Import
        ...
        <div className="max-w-7xl mx-auto px-12 py-16">
          <div className="mb-16">
            <h2 className="text-5xl font-light tracking-tight mb-4">Projekte</h2>
          ...
          <div className="bg-white rounded-3xl p-10 mb-12 shadow-sm border border-gray-200">
            <div className="flex gap-4">
              <input
                ...
                className="flex-1 px-6 py-5 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-black focus:bg-white transition-all text-base"
              />
              <button
                onClick={addClient}
  ...
  if (view === 'sections') {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="max-w-7xl mx-auto px-12 py-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-6">
                ...
                <h1 className="text-2xl font-medium">{selectedClient.name}</h1>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-12 py-16">
          <div className="mb-12">
            <h2 className="text-5xl font-light tracking-tight mb-4">Bereiche</h2>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-12 py-16">
        {view === 'todos' && (
          <div className="bg-white rounded-3xl p-10 mb-12 shadow-sm border border-gray-200">
            <h3 className="text-2xl font-medium mb-6">Neue Aufgabe</h3>
            <div className="space-y-4">
              <input
                type="text"
                value={newTodo}
                ...
                className="w-full px-6 py-5 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-black focus:bg-white transition-all text-base"
              />
              <div className="flex gap-4">
                <input
                  type="date"
